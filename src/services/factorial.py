...
class FactorialService:
    ...
    async def calculate_factorial(self, request: FactorialRequest) -> FactorialResult:
        ...
        try:
            ...
            # Update metrics
            operation_count.labels(operation_type="factorial", status="success").inc()
            operation_duration.labels(operation_type="factorial").observe(duration_ms / 1000)
            ...
            operation_count.labels(operation_type="factorial", status="error").inc()
            raise
