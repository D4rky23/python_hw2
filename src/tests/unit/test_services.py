...
class TestPowerService:
    ...
    @pytest.mark.asyncio
    async def test_calculate_power_success(
        self, power_service, mock_repository
    ):
    ...
    @pytest.mark.asyncio
    async def test_calculate_power_validation_error(
        self, power_service, mock_repository
    ):
...
class TestFibonacciService:
    ...
    @pytest.mark.asyncio
    async def test_calculate_fibonacci_success(
        self, fibonacci_service, mock_repository
    ):
    ...
    @pytest.mark.asyncio
    async def test_calculate_fibonacci_cached(
        self, fibonacci_service, mock_repository
    ):
    ...
    @pytest.mark.asyncio
    async def test_calculate_fibonacci_negative_error(
        self, fibonacci_service, mock_repository
    ):
...
class TestFactorialService:
    ...
    @pytest.mark.asyncio
    async def test_calculate_factorial_success(
        self, factorial_service, mock_repository
    ):
    ...
    @pytest.mark.asyncio
    async def test_calculate_factorial_zero(
        self, factorial_service, mock_repository
    ):
    ...
    @pytest.mark.asyncio
    async def test_calculate_factorial_one(
        self, factorial_service, mock_repository
    ):
