...
class Settings(BaseSettings):
    ...
    max_fibonacci_n: int = Field(
        default=10000,
        description="Maximum value for Fibonacci computation"
    )
    max_factorial_n: int = Field(
        default=5000,
        description="Maximum value for factorial computation"
    )
    max_power_base: int = Field(
        default=1000,
        description="Maximum base value for power computation"
    )
